...
import ru.ifmo.android_2015.citycam.webcams.Cam;
import ru.ifmo.android_2015.citycam.webcams.Webcams;

public class DownloadImageTask extends AsyncTask<City, Void, Cam> {
    private static final String LOGTAG = "Downloading";
    private Activity activity;
    private Cam webcam = null;
    ...
    @Override
    protected Cam doInBackground(City... params) {
        try {
            progress = Progress.GettingInfo;
    ...
    @Override
    protected void onPostExecute(Cam webcam) {
    ...
    private Cam getInfoAboutWebcam(City city) throws IOException {
    ...
    private Cam readWebcam(JsonReader reader) throws IOException {
        Cam res = new Cam();
    ...
    private Bitmap getBitmap(Cam webcam) throws IOException {
