...
public final class LargeRussianCities {
    ...
    private static City createCity(int position) {
        switch (position) {
            ...
            case 65: return new City("Северодвинск", 64.558186, 39.82962 );
            case 66: return new City("Симферополь", 44.952116, 34.102411 );
            case 67: return new City("Сочи", 43.581509, 39.722882);
            case 68: return new City("Ставрополь", 45.044502, 41.969065);
            case 69: return new City("Сухум", 43.015679, 41.025071 );
            case 70: return new City("Тамбов", 52.721246, 41.452238);
            case 71: return new City("Ташкент", 41.314321, 69.267295 );
            case 72: return new City("Тверь", 56.859611, 35.911896);
            case 73: return new City("Тольятти", 53.511311, 49.418084);
            case 74: return new City("Томск", 56.495116, 84.972128);
            case 75: return new City("Тула", 54.193033, 37.617752);
            case 76: return new City("Тюмень", 57.153033, 65.534328 );
            case 77: return new City("Улан-Удэ", 51.833507, 107.584125);
            case 78: return new City("Ульяновск", 54.317002, 48.402243 );
            case 79: return new City("Уфа", 54.734768, 55.957838 );
            case 80: return new City("Хабаровск", 48.472584, 135.057732 );
            case 81: return new City("Харьков", 49.993499, 36.230376 );
            case 82: return new City("Чебоксары", 56.1439, 47.248887);
            case 83: return new City("Челябинск", 55.159774, 61.402455);
            case 84: return new City("Шахты", 47.708485, 40.215958);
            case 85: return new City("Энгельс", 51.498891, 46.125121 );
            case 86: return new City("Южно-Сахалинск", 46.959118, 142.738068 );
            case 87: return new City("Якутск", 62.027833, 129.704151);
            case 88: return new City("Ярославль", 57.626569, 39.893822);
        }
